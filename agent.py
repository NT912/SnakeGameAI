...
from helper import plot, save_plot_image

MAX_MEMORY = 100_000
BATCH_SIZE = 1000
LR = 0.001
MAX_GAMES = 1000  # Định nghĩa giá trị cho MAX_GAMES
...
class Agent:
    ...
    def __init__(self):
        ...
        self.load_model()  # Tải mô hình từ tập tin nếu có
...
def train():
    ...
    while True:
        ...
        if done:
            ...
            # Save plot image after each game
            save_plot_image(plot_scores, plot_mean_scores, agent.n_games)

            # Save model after each game
            agent.save_model()
